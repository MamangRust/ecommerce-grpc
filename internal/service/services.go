...
func NewService(deps Deps) *Service {
	return &Service{
		...
		Transaction: NewTransactionService(deps.Repositories.Merchant, deps.Repositories.Transaction, deps.Repositories.Order, deps.Repositories.OrderItem,
			deps.Repositories.Shipping, deps.Logger, deps.Mapper.TransactionResponseMapper),
