...
func (m *merchantDetailQueryCache) GetCachedMerchantDetail(ctx context.Context, id int) (*response.ApiResponseMerchantDetailCore, bool) {
	key := fmt.Sprintf(merchantDetailByIdCacheKey, id)

	result, found := cache.GetFromCache[response.ApiResponseMerchantDetailCore](ctx, m.store, key)
...
func (m *merchantDetailQueryCache) SetCachedMerchantDetail(ctx context.Context, data *response.ApiResponseMerchantDetailCore) {
	if data == nil {
		return
	}
