...
func (t *transactionQueryCache) SetCachedTransactionActiveCache(ctx context.Context, req *requests.FindAllTransaction, data *response.ApiResponsePaginationTransactionDeleteAt) {
	if data == nil {
		return
	}
