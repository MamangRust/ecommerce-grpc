...
type OrderYearlyResponse struct {
	...
	TotalRevenue       int32                  `protobuf:"varint,3,opt,name=total_revenue,json=totalRevenue,proto3" json:"total_revenue,omitempty"`
	TotalItemsSold     int32                  `protobuf:"varint,4,opt,name=total_items_sold,json=totalItemsSold,proto3" json:"total_items_sold,omitempty"`
	UniqueProductsSold int32                  `protobuf:"varint,5,opt,name=unique_products_sold,json=uniqueProductsSold,proto3" json:"unique_products_sold,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x02pb\x1a\tapi.proto\x1a\x16shipping_address.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\"^\n" +
	...
	"\x05price\x18\x04 \x01(\x05R\x05price\"\x9c\x01\n" +
	...
	"\x10total_items_sold\x18\x04 \x01(\x05R\x0etotalItemsSold\"\xcb\x01\n" +
	"\x13OrderYearlyResponse\x12\x12\n" +
	"\x04year\x18\x01 \x01(\tR\x04year\x12\x1f\n" +
	"\vorder_count\x18\x02 \x01(\x05R\n" +
	"orderCount\x12#\n" +
	"\rtotal_revenue\x18\x03 \x01(\x05R\ftotalRevenue\x12(\n" +
	"\x10total_items_sold\x18\x04 \x01(\x05R\x0etotalItemsSold\x120\n" +
	"\x14unique_products_sold\x18\x05 \x01(\x05R\x12uniqueProductsSold\"\xb8\x01\n" +
	...
	"\n" +
	"updated_at\x18\x06 \x01(\tR\tupdatedAt\"\xfd\x01\n" +
	...
	"\rtotal_revenue\x18\x03 \x01(\x05R\ftotalRevenue\"Z\n" +
	"\x1fOrderYearlyTotalRevenueResponse\x12\x12\n" +
	"\x04year\x18\x01 \x01(\tR\x04year\x12#\n" +
	"\rtotal_revenue\x18\x02 \x01(\x05R\ftotalRevenue\"y\n" +
	...
	"\x1bFindYearlyRevenueByMerchant\x12\x1b.pb.FindYearOrderByMerchant\x1a\x1a.pb.ApiResponseOrderYearly\x12B\n" +
	"\aFindAll\x12\x17.pb.FindAllOrderRequest\x1a\x1e.pb.ApiResponsePaginationOrder\x12:\n" +
	"\bFindById\x12\x18.pb.FindByIdOrderRequest\x1a\x14.pb.ApiResponseOrder\x12Q\n" +
	...
	"\x17DeleteAllOrderPermanent\x12\x16.google.protobuf.Empty\x1a\x17.pb.ApiResponseOrderAll\"\x00B\x17Z\x15ecommerce/internal/pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*CreateShippingAddressRequest)(nil),        // 32: pb.CreateShippingAddressRequest
	(*UpdateShippingAddressRequest)(nil),        // 33: pb.UpdateShippingAddressRequest
...
var file_order_proto_depIdxs = []int32{
	...
	32, // 1: pb.CreateOrderRequest.shipping:type_name -> pb.CreateShippingAddressRequest
	14, // 2: pb.UpdateOrderRequest.items:type_name -> pb.UpdateOrderItemRequest
	33, // 3: pb.UpdateOrderRequest.shipping:type_name -> pb.UpdateShippingAddressRequest
	34, // 4: pb.OrderResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	15, // 5: pb.ApiResponseOrderMonthly.data:type_name -> pb.OrderMonthlyResponse
	16, // 6: pb.ApiResponseOrderYearly.data:type_name -> pb.OrderYearlyResponse
	17, // 7: pb.ApiResponseOrder.data:type_name -> pb.OrderResponse
	18, // 8: pb.ApiResponseOrderDeleteAt.data:type_name -> pb.OrderResponseDeleteAt
	17, // 9: pb.ApiResponsesOrder.data:type_name -> pb.OrderResponse
	18, // 10: pb.ApiResponsePaginationOrderDeleteAt.data:type_name -> pb.OrderResponseDeleteAt
	35, // 11: pb.ApiResponsePaginationOrderDeleteAt.pagination:type_name -> pb.PaginationMeta
	17, // 12: pb.ApiResponsePaginationOrder.data:type_name -> pb.OrderResponse
	35, // 13: pb.ApiResponsePaginationOrder.pagination:type_name -> pb.PaginationMeta
	19, // 14: pb.ApiResponseOrderMonthlyTotalRevenue.data:type_name -> pb.OrderMonthlyTotalRevenueResponse
