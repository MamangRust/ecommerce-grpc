...
func (q *Queries) GetUserByIDWithPassword(ctx context.Context, userID int32) (*GetUserByIDWithPasswordRow, error) {
	row := q.db.QueryRow(ctx, getUserByIDWithPassword, userID)
